...
const Dashboard = () => {
  ...
  const fetchProduct = async () => {
    let url = await fetch(
      "http://localhost/darwin-jewels/Admin-panel/Api-Calls/Dashboard/productCount.php"
    );
  ...
  const fetchCategories = async () => {
    let url = await fetch(
      "http://localhost/darwin-jewels/Admin-panel/Api-Calls/Dashboard/categoriesCount.php"
    );
    let data = await url.json();
  ...
  const fetchBanner = async () => {
    let url = await fetch(
      "http://localhost/darwin-jewels/Admin-panel/Api-Calls/Dashboard/bannerCount.php"
    );
    let data = await url.json();
  ...
  const fetchCollection = async () => {
    let url = await fetch(
      "http://localhost/darwin-jewels/Admin-panel/Api-Calls/Dashboard/featuredCollectionCount.php"
    );
    let data = await url.json();
